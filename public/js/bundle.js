...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./pages/app.js\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));

	var renderTarget = document.getElementById('open-bracket-app');

	// Render the main component with correct path
	React.render(App({ path: window.location.pathname }), renderTarget);
